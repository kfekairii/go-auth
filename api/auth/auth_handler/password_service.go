...
func NewPassWordService() auth_domain.IPasswordService {
...
//
func (s PasswordService) CreateHash(password string) (hash string, err error) {
...
// false.
func (s PasswordService) ComparePasswordAndHash(password string, hash string) (match bool, err error) {
